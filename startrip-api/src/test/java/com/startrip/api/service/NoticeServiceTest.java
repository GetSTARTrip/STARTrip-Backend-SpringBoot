...
class NoticeServiceTest {
    ...
    void notice_view_counting() {
        ...
        org.assertj.core.api.Assertions.assertThat(find.getViewCount()).isEqualTo(1);
    }
    ...
    void notifce_view_100() {
        ...
        org.assertj.core.api.Assertions.assertThat(find.getViewCount()).isEqualTo(10);
    }
    ...
    void notice_post_with_user_and_category() {
        ...
        org.assertj.core.api.Assertions.assertThat(find.getUser().getEmail()).isEqualTo("test@test.com");
        org.assertj.core.api.Assertions.assertThat(find.getCategory().getCategoryName()).isEqualTo("공지사항");
    }
}