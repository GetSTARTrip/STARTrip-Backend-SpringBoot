package com.startrip.api.service.trip;
...
public class PlaceTripServiceTest {
    ...
    public void placetrip_user() {
        ...
        Assertions.assertThat(find.getUserId().getName().compareTo("d"));
        Assertions.assertThat(find.getUserId().getEmail().compareTo("4@4"));
        cleanUp();
    }
}
